...
- **Default scope (v0.4)**: `--window-days 100`, `--max-papers 100`, `--clusters 5`, `--proposals 5`. The 100/100 pair was tuned on observed match densities (most topics produce 50–150 matches in 100 days; top-tier venue ranking ensures conference papers survive the cap before arXiv-only siblings).
